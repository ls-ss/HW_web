/* 1. Необходимо создать html-страницу с названием 1.html, в которой подключить 
    файл 1.js (его тоже необходимо создать рядом с html-файлом). В js-файле 
    необходимо создать следующий скрипт:
...
alert(`Цельсий: ${temp}, Фаренгейт: ${convertToFahrenheit(temp)}`);

function convertToFahrenheit(num) {
    return (1.8 * num + 32).toFixed(1);
}
