...
$works = [
  [
    ...
    "description" => "Изучение рынка, Изучение поведения потребителей, Выбор целевого рынка, Разработка конкурентного преимущества, Утверждение стратегии развития товара, Тактическое управление товаром компании, Контроль и анализ результатов работ.",
    "salary" => "150т.руб.",
  ],
  [
    ...
    "description" => "Составление отчетов, Выявление закономерностей, Сбор данных и настройка инфраструктуры.",
    "salary" => "100т.руб.",
  ],
  [
    ...
    "dateEnd" => "Март 2020",
    "description" => "Приходить в школу.",
    "salary" => "12т.руб. 34 коп.",
  ],
];
?>
<!DOCTYPE html>
